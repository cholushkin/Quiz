...
public class SampleScript : MonoBehaviour
{
    ...
    IEnumerator MyTests()
    {
        Firebase firebase = Firebase.CreateNew("digairquiz.firebaseio.com");
        ...
        //Firebase root = firebase.Child("digairquiz", true);
        //root.OnGetSuccess += GetTimeStamp;

        DoDebug("Firebase key: " + firebase.Key);
        firebase.Child("5", true).GetValue(FirebaseParam.Empty.OrderByKey().LimitToFirst(6));
        firebase.GetValue(FirebaseParam.Empty.OrderByKey().LimitToFirst(3));
